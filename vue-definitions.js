  ...
  methods: {
    ...
    pullData(selectedData, selectedRegion, updateSelectedCountries = true) {
      if (selectedRegion == 'Saudi Arabia') {
        ...
        const url = 'https://mapsaudi.com/geoserver/ows?outputFormat=csv&service=WFS&srs=EPSG%3A3857&request=GetFeature&typename=geonode%3Acasestrial&version=1.0.0'
